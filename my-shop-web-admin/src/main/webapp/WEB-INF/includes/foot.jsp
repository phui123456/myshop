    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="btnConfirmOk" type="button" class="btn btn-primary">确定</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modal-alert">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="btnAlertOk" type="button" class="btn btn-primary">确定</button>
            </div>
        </div>
    </div>
</div>
...
<!-- MyShop App -->
<script src="/static/assets/app/media.js"></script>
